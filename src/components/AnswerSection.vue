...
<template>
    <div class="container mx-auto px-4 lg:max-w-60 lg:mt-4 mt-2 pb-20" >
        ...
        <div class="lg:mt-6 mt-2 bg-opacity-80 p-6 rounded-lg hidden">
            <PaginationBar
                v-model="pageNumber"
                :total-row="totalRow"
