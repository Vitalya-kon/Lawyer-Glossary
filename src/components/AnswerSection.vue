...
const change = (data: PageInfo): void =>{
...
<template>
    <div class="container mx-auto px-4 lg:max-w-60 lg:mt-8 mt-4 pb-20" >
        <div class="cursor-pointer" @click="backToStart">
            <svg width="64px" height="64px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M11 9L8 12M8 12L11 15M8 12H16M7.2 20H16.8C17.9201 20 18.4802 20 18.908 19.782C19.2843 19.5903 19.5903 19.2843 19.782 18.908C20 18.4802 20 17.9201 20 16.8V7.2C20 6.0799 20 5.51984 19.782 5.09202C19.5903 4.71569 19.2843 4.40973 18.908 4.21799C18.4802 4 17.9201 4 16.8 4H7.2C6.0799 4 5.51984 4 5.09202 4.21799C4.71569 4.40973 4.40973 4.71569 4.21799 5.09202C4 5.51984 4 6.07989 4 7.2V16.8C4 17.9201 4 18.4802 4.21799 18.908C4.40973 19.2843 4.71569 19.5903 5.09202 19.782C5.51984 20 6.07989 20 7.2 20Z" stroke="#6b7280" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
        </div>
        <div data-aos="fade-up" v-for="(item, index) in props.data" :key="index" class="lg:mt-6 mt-2 bg-gray-500 bg-opacity-80 p-6 rounded-lg" v-if="props.data && props.data.length">           
            <div class="relative">
                ...
                <p class="mb-4 text-center " >
                    <span class="font-bold font-manrope mx-5  text-gray-800 text-xl lg:text-2xl bg-yellow-100 inline-block rounded-lg px-3">{{ item.key }}</span>
                </p>
                <p class="text-white font-manrope text-sm lg:text-lg  font-semibold " v-html="item.value"></p>
            </div>
            
        </div>
        <div class="lg:mt-6 mt-2 bg-opacity-80 p-6 rounded-lg">
            <PaginationBar
                v-model="pageNumber"
                :total-row="totalRow"
