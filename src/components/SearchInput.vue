    ...
    <div class="container mx-auto px-4 sticky top-4 z-10">
        <form class="lg:max-w-md mx-auto w-full lg:w-1/2 mt-6">   
            ...
            <div class="relative">
                ...
                <input type="search" id="default-search" :value="searchQuery" @input="searchQuery = $event.target.value" class="block w-full p-3 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Найдем ответы..." required />
            </div>
        </form>
    </div>
